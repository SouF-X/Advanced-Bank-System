...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        vector <string> TransferLogLine = clsString::Split(Line, Seperator);

        TransferLogRecord.DateTime = TransferLogLine[0];
        TransferLogRecord.SourceAccountNumber = TransferLogLine[1];
        TransferLogRecord.DestinationAccountNumber = TransferLogLine[2];
        TransferLogRecord.Amount = stoi(TransferLogLine[3]);
        TransferLogRecord.srcBalanceAfter = stoi(TransferLogLine[4]);
        TransferLogRecord.destBalanceAfter = stoi(TransferLogLine[5]);
        TransferLogRecord.UserName = TransferLogLine[6];
    ...
    string _PreparTransferLog(float Amount , clsBankClient DestinationClient, string UserName, string Seperator = "#//#")
    {
        string TransferLog = "";
    ...
    {
        string stDataLine = _PreparTransferLog(Amount, DestinationClient, UserName);
